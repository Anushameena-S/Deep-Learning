...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory(r'C:\Users\Anusha\OneDrive\Documents\MS Program Online\AI Internship\AI Practice\DL\CharacterRecognition\Dataset\train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory(r'C:\Users\Anusha\OneDrive\Documents\MS Program Online\AI Internship\AI Practice\DL\CharacterRecognition\Dataset\test',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
...
##
        ...
        with open("model.keras", "w") as json_file:
